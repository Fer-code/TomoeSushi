...
public class Order implements Serializable {
     ...
     * @param urgencia
     */
    public Order(Integer os, String data, String hora, String tecnico, Integer idCliente, String cliente, String contato, String sistema, String motivo, Integer urgencia, String departamento, String pendente) {
        super();
        this.os = os;
        this.data = data;
        this.hora = hora;
